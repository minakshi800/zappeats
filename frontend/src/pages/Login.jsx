      ...
      >
        ...
        >
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-sm sm:text-base text-gray-600 dark:text-dark-muted">Sign in to continue to ZappEats</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-end">
              <Link
                to="/forgot-password"
                className="text-sm text-orange-500 hover:text-pink-500 font-medium transition-colors"
              >
                Forgot password?
              </Link>
            </div>
